      ...
      <nav className="flex items-center navegacion">
        <ul className="flex w-full justify-between gap-14 px-8 font-semibold text-lg">
          ...
          <div className="flex gap-5">
            <li>
              <Link className="bg-lime-600 px-3 py-1 rounded-md text-white" to="inicioSesion">
                Iniciar sesión
              </Link>
            </li>
            <li>
              <Link className="px-3 py-1 border border-lime-600 rounded-md text-lime-600" to="Registro">Crear cuenta</Link>
            </li>
          </div>
        </ul>
      </nav>
